...
- The RESULT MUST READ AS WRITTEN FOR THIS SPECIFIC JOB. If a reader skims only the SUMMARY + the first work-experience bullets, they must be able to tell which job this resume targets. NEVER output a resume that looks like the generic source resume unchanged.
